...
class CreatePage extends CreateElement
{
    ...
    protected function generateSECTIONSECTPR($rId = '00012240')
    {
        $xml = '<' . CreateElement::NAMESPACEWORD . ':sectPr ' .
                \Phpdocx\Create\CreateDocx::NAMESPACEWORD . ':rsidR="' . $rId . '" ' .
                \Phpdocx\Create\CreateDocx::NAMESPACEWORD . ':rsidRPr="' . $rId . '" ' .
                \Phpdocx\Create\CreateDocx::NAMESPACEWORD . ':rsidSect="' . $rId .
